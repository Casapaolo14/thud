...
Solo in alcune interfacce iniziali i colori utilizzati sono stati 8: Select \ref{select}, Pie \ref{pie}. % ref ref
I motivi della riduzione delle tonalità da 8 a 6 verranno affrontati nel capitolo successivo \ref{design}. % ref
...
\section{Interfaccia Wrist Rotation} % rotazione con menu a U click apro, click chiudo
